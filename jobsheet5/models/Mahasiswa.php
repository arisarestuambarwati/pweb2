...
class Mahasiswa
{
    ...
    {
        $query="SELECT * FROM mahasiswa wher id= $id";
        $result=mysqli_query($this->koneksi, $query);
    ...
    {
       $query="UPDATE mahasiswa set nim='$nim', nama='$nama', tempat_lahir='$tempat_lahir', jenis_kelamin='$jenis_kelamin',
    ...
    public function deleteMahasiswa($id){
        $query = "DELETE FOM mahasiswa WHERE id=$id";
        $result = mysqli_query($this->koneksi, $query);
        if ($result) {
            return true;
        }else {
